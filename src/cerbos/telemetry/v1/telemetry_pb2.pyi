...
class ServerLaunch(_message.Message):
    ...
    class Features(_message.Message):
        ...
        class Audit(_message.Message):
            ...
            enabled: bool
            backend: str
            def __init__(self, enabled: _Optional[bool] = ..., backend: _Optional[str] = ...) -> None: ...
        ...
        class Storage(_message.Message):
            ...
            class Disk(_message.Message):
                ...
                watch: bool
                def __init__(self, watch: _Optional[bool] = ...) -> None: ...
            class Git(_message.Message):
                ...
                def __init__(self, protocol: _Optional[str] = ..., auth: _Optional[bool] = ..., poll_interval: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
            class Blob(_message.Message):
                ...
                provider: str
                poll_interval: _duration_pb2.Duration
                def __init__(self, provider: _Optional[str] = ..., poll_interval: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ...) -> None: ...
    ...
    class Stats(_message.Message):
        ...
        class Policy(_message.Message):
            __slots__ = ("count", "avg_rule_count", "avg_condition_count", "condition_count", "rule_count", "max_condition_count", "max_rule_count", "distinct_action_count", "distinct_resource_count", "has_output", "has_scoped_policies")
            ...
            class AvgConditionCountEntry(_message.Message):
                ...
                value: float
                def __init__(self, key: _Optional[str] = ..., value: _Optional[float] = ...) -> None: ...
            class ConditionCountEntry(_message.Message):
                __slots__ = ("key", "value")
                KEY_FIELD_NUMBER: _ClassVar[int]
                VALUE_FIELD_NUMBER: _ClassVar[int]
                key: str
                value: int
                def __init__(self, key: _Optional[str] = ..., value: _Optional[int] = ...) -> None: ...
            class RuleCountEntry(_message.Message):
                __slots__ = ("key", "value")
                KEY_FIELD_NUMBER: _ClassVar[int]
                VALUE_FIELD_NUMBER: _ClassVar[int]
                key: str
                value: int
                def __init__(self, key: _Optional[str] = ..., value: _Optional[int] = ...) -> None: ...
            class MaxConditionCountEntry(_message.Message):
                __slots__ = ("key", "value")
                KEY_FIELD_NUMBER: _ClassVar[int]
                VALUE_FIELD_NUMBER: _ClassVar[int]
                key: str
                value: int
                def __init__(self, key: _Optional[str] = ..., value: _Optional[int] = ...) -> None: ...
            class MaxRuleCountEntry(_message.Message):
                __slots__ = ("key", "value")
                KEY_FIELD_NUMBER: _ClassVar[int]
                VALUE_FIELD_NUMBER: _ClassVar[int]
                key: str
            ...
            CONDITION_COUNT_FIELD_NUMBER: _ClassVar[int]
            RULE_COUNT_FIELD_NUMBER: _ClassVar[int]
            MAX_CONDITION_COUNT_FIELD_NUMBER: _ClassVar[int]
            MAX_RULE_COUNT_FIELD_NUMBER: _ClassVar[int]
            DISTINCT_ACTION_COUNT_FIELD_NUMBER: _ClassVar[int]
            DISTINCT_RESOURCE_COUNT_FIELD_NUMBER: _ClassVar[int]
            HAS_OUTPUT_FIELD_NUMBER: _ClassVar[int]
            HAS_SCOPED_POLICIES_FIELD_NUMBER: _ClassVar[int]
            ...
            condition_count: _containers.ScalarMap[str, int]
            rule_count: _containers.ScalarMap[str, int]
            max_condition_count: _containers.ScalarMap[str, int]
            max_rule_count: _containers.ScalarMap[str, int]
            distinct_action_count: int
            distinct_resource_count: int
            has_output: bool
            has_scoped_policies: bool
            def __init__(self, count: _Optional[_Mapping[str, int]] = ..., avg_rule_count: _Optional[_Mapping[str, float]] = ..., avg_condition_count: _Optional[_Mapping[str, float]] = ..., condition_count: _Optional[_Mapping[str, int]] = ..., rule_count: _Optional[_Mapping[str, int]] = ..., max_condition_count: _Optional[_Mapping[str, int]] = ..., max_rule_count: _Optional[_Mapping[str, int]] = ..., distinct_action_count: _Optional[int] = ..., distinct_resource_count: _Optional[int] = ..., has_output: _Optional[bool] = ..., has_scoped_policies: _Optional[bool] = ...) -> None: ...
        class Schema(_message.Message):
            __slots__ = ("count",)
            COUNT_FIELD_NUMBER: _ClassVar[int]
            count: int
...
class ServerStop(_message.Message):
    ...
    requests_total: int
    def __init__(self, version: _Optional[str] = ..., uptime: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., requests_total: _Optional[int] = ...) -> None: ...
...
class Event(_message.Message):
    ...
    class ApiActivity(_message.Message):
        ...
        def __init__(self, version: _Optional[str] = ..., uptime: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., method_calls: _Optional[_Iterable[_Union[Event.CountStat, _Mapping]]] = ..., user_agents: _Optional[_Iterable[_Union[Event.CountStat, _Mapping]]] = ...) -> None: ...
