...
class CerbosClient(ClientBase):
    ...
    @handle_errors
    def plan_resources(self, action: str, principal: engine_pb2.Principal, resource: engine_pb2.PlanResourcesInput.Resource, request_id: Union[str, None]=None, aux_data: Union[request_pb2.AuxData, None]=None) -> response_pb2.PlanResourcesResponse:
...
class PrincipalContext:
    ...
    def plan_resources(self, action: str, resource: engine_pb2.PlanResourcesInput.Resource, request_id: Union[str, None]=None, aux_data: Union[request_pb2.AuxData, None]=None) -> response_pb2.PlanResourcesResponse:
        """Create a query plan for performing the given action on resources of the given kind
