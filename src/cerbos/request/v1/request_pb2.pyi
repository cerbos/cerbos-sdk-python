...
class PlanResourcesRequest(_message.Message):
    __slots__ = ("request_id", "action", "actions", "principal", "resource", "aux_data", "include_meta", "request_context")
    ...
    aux_data: AuxData
    include_meta: bool
    request_context: _audit_pb2.RequestContext
    def __init__(self, request_id: _Optional[str] = ..., action: _Optional[str] = ..., actions: _Optional[_Iterable[str]] = ..., principal: _Optional[_Union[_engine_pb2.Principal, _Mapping]] = ..., resource: _Optional[_Union[_engine_pb2.PlanResourcesInput.Resource, _Mapping]] = ..., aux_data: _Optional[_Union[AuxData, _Mapping]] = ..., include_meta: _Optional[bool] = ..., request_context: _Optional[_Union[_audit_pb2.RequestContext, _Mapping]] = ...) -> None: ...
...
class CheckResourceSetRequest(_message.Message):
    ...
    include_meta: bool
    aux_data: AuxData
    def __init__(self, request_id: _Optional[str] = ..., actions: _Optional[_Iterable[str]] = ..., principal: _Optional[_Union[_engine_pb2.Principal, _Mapping]] = ..., resource: _Optional[_Union[ResourceSet, _Mapping]] = ..., include_meta: _Optional[bool] = ..., aux_data: _Optional[_Union[AuxData, _Mapping]] = ...) -> None: ...
...
class CheckResourcesRequest(_message.Message):
    __slots__ = ("request_id", "include_meta", "principal", "resources", "aux_data", "request_context")
    ...
    aux_data: AuxData
    request_context: _audit_pb2.RequestContext
    def __init__(self, request_id: _Optional[str] = ..., include_meta: _Optional[bool] = ..., principal: _Optional[_Union[_engine_pb2.Principal, _Mapping]] = ..., resources: _Optional[_Iterable[_Union[CheckResourcesRequest.ResourceEntry, _Mapping]]] = ..., aux_data: _Optional[_Union[AuxData, _Mapping]] = ..., request_context: _Optional[_Union[_audit_pb2.RequestContext, _Mapping]] = ...) -> None: ...
...
class AuxData(_message.Message):
    ...
    def __init__(self, jwt: _Optional[_Union[AuxData.JWT, _Mapping]] = ..., jwts: _Optional[_Mapping[str, AuxData.JWT]] = ...) -> None: ...
...
class ListAuditLogEntriesRequest(_message.Message):
    ...
    lookup: str
    def __init__(self, kind: _Optional[_Union[ListAuditLogEntriesRequest.Kind, str]] = ..., tail: _Optional[int] = ..., between: _Optional[_Union[ListAuditLogEntriesRequest.TimeRange, _Mapping]] = ..., since: _Optional[_Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]] = ..., lookup: _Optional[str] = ...) -> None: ...
...
class ListPoliciesRequest(_message.Message):
    ...
    def __init__(self, include_disabled: _Optional[bool] = ..., name_regexp: _Optional[str] = ..., scope_regexp: _Optional[str] = ..., version_regexp: _Optional[str] = ..., policy_id: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ReloadStoreRequest(_message.Message):
    ...
    wait: bool
    def __init__(self, wait: _Optional[bool] = ...) -> None: ...

class PurgeStoreRevisionsRequest(_message.Message):
    __slots__ = ("keep_last",)
    KEEP_LAST_FIELD_NUMBER: _ClassVar[int]
    keep_last: int
    def __init__(self, keep_last: _Optional[int] = ...) -> None: ...
